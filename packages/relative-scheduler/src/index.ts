import { IParentScheduler, IScheduledTask, IScheduler, ITask, ITime } from '@euphony/types'

export default class RelativeScheduler<Time extends ITime, Timecode extends ITime, RootTimecode extends ITime>
