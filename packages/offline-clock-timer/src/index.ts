import { IClock, ITime, ITimer } from '@euphony/types'
...
export default class OfflineClockTimer<Time extends ITime> implements IClock<Time>, ITimer<Time> {
